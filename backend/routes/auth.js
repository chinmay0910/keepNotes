...
const JWT_SECRET = "passwordismadesecuredbychinmayWebApp"; // This is to be stored in env.local for security purposes.


// Route 1: route for the api with the route og localhost/api/auth/createuser
router.post('/createuser',[body('name', "Name should atleast be of length 2").isLength({min: 2}), body('email','Enter valid email id!').isEmail(), body('password', "Password should atleast be of length 2").isLength({min: 2})],async (req, res) => {
